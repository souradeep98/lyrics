...
class MediaInfo(
    ...
    val position: Long,
    val occurrenceTime: LocalDateTime = LocalDateTime.now(),
    val duration: Long,
    val state: Int,
    val mediaID: String?,
) {
    companion object {
        ...
        fun fromJson(json: Map<String, Any>): MediaInfo {
            ...
            return MediaInfo(
                ...
                LocalDateTime.parse(json["occurrenceTime"] as String, iso8601Format),
    ...
    fun toJson(): Map<String, Any?> {
        ...
        return mapOf(
            ...
            "occurrenceTime" to occurrenceTime.toIso8601String(),
